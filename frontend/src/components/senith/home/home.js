...
{/* Book mangement */}
    ...
    <div className="card">
    <a href="/book">
  <img src={book} alt="John" style={{ width: '200px', height: '200px', margin: '5px'}}/>
...
<div className="column1">
    <div className="card">
    <a href="/staff">
  <img src={staff} alt="John" style={{ width: '200px', height: '200px', margin: '5px'}}/>
...
{/* Report mangement */}
    ...
    <div className="card">
    <a href="/reports">
  <img src={report} alt="John" style={{ width: '200px', height: '200px', margin: '5px'}}/>
